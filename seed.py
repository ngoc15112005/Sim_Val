...
CLUBS = {
    'pacific': [
        ...
        ('T1', 'T1', 82, '1677137430839_T1_infoboximage1.png'),
        ('DRX', 'DRX', 80, '1651626649157_download1.png'),
        ('Gen.G', 'GEN', 83, '1775114509356_GENGLOGO_GOLD.png'),
    ...
    'americas': [
        ...
        ('Sentinels', 'SEN', 82, '1739254422982_sent.png'),
        ('Leviatan', 'LEV', 82, '1644148043034_Leviatncolor.png'),
        ...
        ('Evil Geniuses', 'EG', 78, '1731490673901_VintageEG.png'),
    ...
    'emea': [
        ...
        ('Team Heretics', 'TH', 83, '1674060672534_600px-Team_Heretics_2022_allmode1.png'),
        ...
        ('Team Vitality', 'VIT', 78, '1722030793680_VITALITY_YELLOW.png'),
